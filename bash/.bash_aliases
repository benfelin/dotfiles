...
#alias tmux='TERM=xterm-256color /local/bin/tmux' 

#-------------------------------------------------------------
# mozilla
#-------------------------------------------------------------

#alias fff="find $HOME/.mozilla/firefox -name *lock -exec rm -f {} \;"
#alias ftb="find $HOME/.thunderbird -name *lock -exec rm -f {} \;"
